# Awesome-IT-Books  
集合各个优秀IT书籍&API 翻译&官方Docs 翻译。  
这个仓库不产出书籍，只是将网上流传着的Book集合在一起，供大家检索学习。  
...
现在有这样一个github仓库，旨在维护一个目录，集合各个优秀的IT技术书籍和技术翻译，方便大家进行检索。  
不过这个项目还需要大家的共同努力，个人的接触面有限，不能接触到所有的优秀的书籍。那么就需要你的加入，来共同完善这个目录。
地址：https://github.com/piggsoft/Awesome-IT-Books

当前已加入了一些书籍，质量很不错，可以作为IT从业人员进行学习的书籍
